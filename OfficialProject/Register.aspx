<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="OfficialProject.Register" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <link rel="stylesheet" href="StylePost.css" />
        ...
        <br />
        <h2 class="SlideUp"><b>Register Form:</b></h2>
        <br />
        <br />
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="text" Id="UserName" name="UserName"  maxlength="10" 
            ...
            <tr>
                ...
                <td><input type="password" Id="PassWord" name="PassWord" minlength="6"  maxlength="15" 
                    required /> </td>
        ...
        <br />
        <table border ="1" style="margin: 0 auto; direction: ltr;">
            <%= st %>
        </table>
